...
foreach ($content as $row) {
    ...
    echo "<a href='comment.php?id=" . $row["ID"] . "' class='btn btn-primary'>Comment on Post</a>";
    echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    echo "<a href='allcomment.php?id=" . $row["ID"] . "' class='btn btn-success'>Show All Comments</a>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    echo "<br>";
